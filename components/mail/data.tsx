export const mails = [
    ...
    replies: [
      {
        ...
        text: "Hi William,\n\nThanks for organizing this. I've reviewed the project documents and have several points to discuss. I think we should focus on the timeline adjustments you mentioned last week.\n\nI'll prepare a brief presentation of my findings.\n\nBest, Alicia",
        date: "2025-02-06T11:15:00",
        read: true,
        labels: ["meeting", "work"],
      },
      {
        ...
        email: "williamsmith@example.com",
        subject: "Re: Meeting Tomorrow",
        text: "Perfect, Alicia!\n\nI've also invited Sarah from the design team as she has some valuable insights on the user interface aspects we'll be discussing.\n\nSee you all tomorrow,\nWilliam",
        date: "2025-02-06T11:45:00",
        read: true,
        labels: ["meeting", "work"],
      },
    ],
  },
  {
    ...
    text: "Hello team,\n\nI wanted to share our latest project progress. We've hit several key milestones ahead of schedule, and I'm impressed with everyone's contributions.\n\nPlease review the attached report and let me know your thoughts.\n\nBest regards, Alice",
    ...
    replies: [
      {
        ...
        text: "Hi Alice,\n\nThis is excellent news! The progress report looks very promising. I particularly appreciate the detailed analysis of our resource utilization.\n\nI have a few suggestions for the next phase that I'll outline in the meeting tomorrow.\n\nBest regards,\nAlicia",
  ...
  },
  {
    ...
    text: "Hi Alicia,\n\nI need your input on the Q1 budget allocation. There seem to be some discrepancies in the marketing department's expenses.\n\nCould we schedule a quick call to discuss this?\n\nBest,\nEmily",
    date: "2025-01-01T13:15:00",
    read: false,
    labels: ["work", "budget"],
    replies: [
      {
        id: "61c35085-72d7-42b4-8d62-738f700d4b93",
        name: "Alicia Koch",
        email: "alicia@example.com",
        subject: "Re: Question about Budget",
        text: "Hi Emily,\n\nI've noticed those discrepancies as well. I'm available for a call tomorrow between 2-4 PM. I've already started reviewing the numbers and have some initial thoughts.\n\nLet me know what time works best for you.\n\nBest,\nAlicia",
        date: "2025-01-01T14:20:00",
        read: true,
        labels: ["work", "budget"],
      },
      {
        id: "61c35085-72d7-42b4-8d62-738f700d4b94",
        name: "Emily Davis",
        email: "emilydavis@example.com",
        subject: "Re: Question about Budget",
        text: "Thanks Alicia,\n\n2:30 PM works perfectly for me. I'll send a calendar invite with the meeting details.\n\nI'll prepare a summary of the specific discrepancies I've found for our discussion.\n\nBest,\nEmily",
        date: "2025-01-01T14:45:00",
        read: true,
        labels: ["work", "budget"],
      },
    ],
